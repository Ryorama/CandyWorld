...
public class CandyRecipes extends RecipeProvider {
	...
	protected void buildRecipes(Consumer<FinishedRecipe> consumer) {
		SimpleCookingRecipeBuilder.smelting(Ingredient.of(Items.SUGAR), RecipeCategory.MISC,
				COTTON_CANDY.get(), 0.35F, 200).unlockedBy("has_sugar", has(Items.SUGAR)).save(consumer);

		SimpleCookingRecipeBuilder.smelting(Ingredient.of(MILK_CHOCOLATE_EGG.get()), RecipeCategory.MISC,
		...
		SimpleCookingRecipeBuilder.smelting(Ingredient.of(WHITE_CHOCOLATE_EGG.get()), RecipeCategory.MISC,
		...
		SimpleCookingRecipeBuilder.smelting(Ingredient.of(DARK_CHOCOLATE_EGG.get()), RecipeCategory.MISC,
		...
		SimpleCookingRecipeBuilder.smelting(Ingredient.of(MILK_CHOCOLATE_BRICK.get()), RecipeCategory.MISC,
		...
		SimpleCookingRecipeBuilder.smelting(Ingredient.of(WHITE_CHOCOLATE_BRICK.get()), RecipeCategory.MISC,
		...
		SimpleCookingRecipeBuilder.smelting(Ingredient.of(DARK_CHOCOLATE_BRICK.get()), RecipeCategory.MISC,
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, BUTTER.get())
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, WAFER_STICK.get(), 3)
		...
		ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, WAFER_STICK.get(), 4)
		...
		ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RED_CANDY_CANE.get(), 4)
		...
		ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, GREEN_CANDY_CANE.get(), 4)
		...
		ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, WHITE_RED_CANDY_CANE.get(), 4)
		...
		ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, WHITE_GREEN_CANDY_CANE.get(), 4)
		...
		ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RED_GREEN_CANDY_CANE.get(), 4)
		...
		ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, MILK_BROWNIE.get(), 6)
		...
		ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, MILK_BROWNIE.get(), 4)
		...
		ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, WHITE_BROWNIE.get(), 6)
		...
		ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, WHITE_BROWNIE.get(), 4)
		...
		ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, DARK_BROWNIE.get(), 6)
		...
		ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, DARK_BROWNIE.get(), 4)
		...
		ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, MILK_CHOCOLATE_BAR.get(), 4)
		...
		ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, MILK_CHOCOLATE_BAR.get(), 3)
				.requires(Items.COCOA_BEANS).requires(Items.SUGAR).requires(Items.MILK_BUCKET)
				.unlockedBy("has_cocoa_beans", has(Items.COCOA_BEANS))
				.save(consumer);

		ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, WHITE_CHOCOLATE_BAR.get(), 4)
		...
		ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, WHITE_CHOCOLATE_BAR.get(), 3)
		...
		ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, DARK_CHOCOLATE_BAR.get(), 4)
		...
		ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, DARK_CHOCOLATE_BAR.get(), 3)
				.requires(Items.COCOA_BEANS).requires(Items.COCOA_BEANS).requires(Items.SUGAR).requires(Items.MILK_BUCKET)
				.unlockedBy("has_cocoa_beans", has(Items.COCOA_BEANS))
				.save(consumer);

		ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RED_GUMMY.get(), 4)
				...
				.save(consumer);
		ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RED_GUMMY.get(), 3)
		...
		ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, ORANGE_GUMMY.get(), 4)
				.requires(Items.SUGAR).requires(Items.SUGAR).requires(Items.WATER_BUCKET)
				...
				.save(consumer);
		ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, ORANGE_GUMMY.get(), 3)
		...
		ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, YELLOW_GUMMY.get(), 4)
				.requires(Items.SUGAR).requires(Items.SUGAR).requires(Items.WATER_BUCKET)
				...
				.save(consumer);
		ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, YELLOW_GUMMY.get(), 3)
		...
		ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, WHITE_GUMMY.get(), 4)
				.requires(Items.SUGAR).requires(Items.SUGAR).requires(Items.WATER_BUCKET)
				...
				.save(consumer);
		ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, WHITE_GUMMY.get(), 3)
		...
		ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, GREEN_GUMMY.get(), 4)
				.requires(Items.SUGAR).requires(Items.SUGAR).requires(Items.WATER_BUCKET)
				...
				.save(consumer);
		ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, GREEN_GUMMY.get(), 3)
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RED_GUMMY_WORM.get())
				.define('#', RED_GUMMY.get()).pattern("  #").pattern(" # ").pattern("#  ")
				.unlockedBy("has_red_gummy", has(RED_GUMMY.get())).save(consumer);
		ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, RED_GUMMY_WORM.get(), 4)
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ORANGE_GUMMY_WORM.get())
				.define('#', ORANGE_GUMMY.get()).pattern("  #").pattern(" # ").pattern("#  ")
				.unlockedBy("has_orange_gummy", has(ORANGE_GUMMY.get())).save(consumer);
		ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, ORANGE_GUMMY_WORM.get(), 4)
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, YELLOW_GUMMY_WORM.get())
				.define('#', YELLOW_GUMMY.get()).pattern("  #").pattern(" # ").pattern("#  ")
				.unlockedBy("has_yellow_gummy", has(YELLOW_GUMMY.get())).save(consumer);
		ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, YELLOW_GUMMY_WORM.get(), 4)
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, WHITE_GUMMY_WORM.get())
				.define('#', WHITE_GUMMY.get()).pattern("  #").pattern(" # ").pattern("#  ")
				.unlockedBy("has_white_gummy", has(WHITE_GUMMY.get())).save(consumer);
		ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, WHITE_GUMMY_WORM.get(), 4)
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, GREEN_GUMMY_WORM.get())
				.define('#', GREEN_GUMMY.get()).pattern("  #").pattern(" # ").pattern("#  ")
				.unlockedBy("has_green_gummy", has(GREEN_GUMMY.get())).save(consumer);
		ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, GREEN_GUMMY_WORM.get(), 4)
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, TELEPORTER.get())
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, MILK_CHOCOLATE_PICKAXE.get())
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, MILK_CHOCOLATE_AXE.get())
				.define('B', MILK_CHOCOLATE_BAR.get()).define('W', WAFER_STICK.get())
				.pattern("BB ").pattern("BW ").pattern(" W ")
				.unlockedBy("has_milk_chocolate_bar", has(MILK_CHOCOLATE_BAR.get())).save(consumer);
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, MILK_CHOCOLATE_SHOVEL.get())
				.define('B', MILK_CHOCOLATE_BAR.get()).define('W', WAFER_STICK.get())
				.pattern(" B ").pattern(" W ").pattern(" W ")
				.unlockedBy("has_milk_chocolate_bar", has(MILK_CHOCOLATE_BAR.get())).save(consumer);
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, MILK_CHOCOLATE_SWORD.get())
				.define('B', MILK_CHOCOLATE_BAR.get()).define('W', WAFER_STICK.get())
				.pattern(" B ").pattern(" B ").pattern(" W ")
				.unlockedBy("has_milk_chocolate_bar", has(MILK_CHOCOLATE_BAR.get())).save(consumer);

		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, WHITE_CHOCOLATE_PICKAXE.get())
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, WHITE_CHOCOLATE_AXE.get())
				.define('B', WHITE_CHOCOLATE_BAR.get()).define('W', WAFER_STICK.get())
				.pattern("BB ").pattern("BW ").pattern(" W ")
				.unlockedBy("has_white_chocolate_bar", has(WHITE_CHOCOLATE_BAR.get())).save(consumer);
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, WHITE_CHOCOLATE_SHOVEL.get())
				.define('B', WHITE_CHOCOLATE_BAR.get()).define('W', WAFER_STICK.get())
				.pattern(" B ").pattern(" W ").pattern(" W ")
				.unlockedBy("has_white_chocolate_bar", has(WHITE_CHOCOLATE_BAR.get())).save(consumer);
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, WHITE_CHOCOLATE_SWORD.get())
				.define('B', WHITE_CHOCOLATE_BAR.get()).define('W', WAFER_STICK.get())
				.pattern(" B ").pattern(" B ").pattern(" W ")
				.unlockedBy("has_white_chocolate_bar", has(WHITE_CHOCOLATE_BAR.get())).save(consumer);

		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, DARK_CHOCOLATE_PICKAXE.get())
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, DARK_CHOCOLATE_AXE.get())
				.define('B', DARK_CHOCOLATE_BAR.get()).define('W', WAFER_STICK.get())
				.pattern("BB ").pattern("BW ").pattern(" W ")
				.unlockedBy("has_dark_chocolate_bar", has(DARK_CHOCOLATE_BAR.get())).save(consumer);
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, DARK_CHOCOLATE_SHOVEL.get())
				.define('B', DARK_CHOCOLATE_BAR.get()).define('W', WAFER_STICK.get())
				.pattern(" B ").pattern(" W ").pattern(" W ")
				.unlockedBy("has_dark_chocolate_bar", has(DARK_CHOCOLATE_BAR.get())).save(consumer);
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, DARK_CHOCOLATE_SWORD.get())
				.define('B', DARK_CHOCOLATE_BAR.get()).define('W', WAFER_STICK.get())
				.pattern(" B ").pattern(" B ").pattern(" W ")
				.unlockedBy("has_dark_chocolate_bar", has(DARK_CHOCOLATE_BAR.get())).save(consumer);

		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, COTTON_CANDY_PICKAXE.get())
				.define('B', COTTON_CANDY.get()).define('W', WAFER_STICK.get())
				.pattern("BBB").pattern(" W ").pattern(" W ")
				.unlockedBy("has_cotton_candy", has(COTTON_CANDY.get())).save(consumer);
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, COTTON_CANDY_AXE.get())
				.define('B', COTTON_CANDY.get()).define('W', WAFER_STICK.get())
				.pattern("BB ").pattern("BW ").pattern(" W ")
				.unlockedBy("has_cotton_candy", has(COTTON_CANDY.get())).save(consumer);
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, COTTON_CANDY_SHOVEL.get())
				.define('B', COTTON_CANDY.get()).define('W', WAFER_STICK.get())
				.pattern(" B ").pattern(" W ").pattern(" W ")
				.unlockedBy("has_cotton_candy", has(COTTON_CANDY.get())).save(consumer);
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, COTTON_CANDY_SWORD.get())
				.define('B', COTTON_CANDY.get()).define('W', WAFER_STICK.get())
				.pattern(" B ").pattern(" B ").pattern(" W ")
				.unlockedBy("has_cotton_candy", has(COTTON_CANDY.get())).save(consumer);

		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, SUGAR_SAND.get())
				.define('#', Items.SUGAR).pattern("##").pattern("##")
				.unlockedBy("has_sugar", has(Items.SUGAR)).save(consumer);

		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, WHITE_CANDY_CANE_BLOCK.get())
				.define('#', WHITE_CANDY_CANE.get()).pattern("##").pattern("##")
				.unlockedBy("has_white_candy_cane", has(WHITE_CANDY_CANE.get())).save(consumer);

		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RED_CANDY_CANE_BLOCK.get())
				.define('#', RED_CANDY_CANE.get()).pattern("##").pattern("##")
				.unlockedBy("has_red_candy_cane", has(RED_CANDY_CANE.get())).save(consumer);

		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, GREEN_CANDY_CANE_BLOCK.get())
				.define('#', GREEN_CANDY_CANE.get()).pattern("##").pattern("##")
				.unlockedBy("has_green_candy_cane", has(GREEN_CANDY_CANE.get())).save(consumer);

		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, WHITE_RED_CANDY_CANE_BLOCK.get())
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, WHITE_GREEN_CANDY_CANE_BLOCK.get())
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RED_GREEN_CANDY_CANE_BLOCK.get())
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, DARK_CHOCOLATE_BRICK.get())
				.define('#', DARK_CHOCOLATE_BAR.get()).pattern("##").pattern("##").unlockedBy("has_dark_chocolate_bar",
						has(DARK_CHOCOLATE_BAR.get())).save(consumer);

		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, MILK_CHOCOLATE_BRICK.get(), 4)
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, WHITE_CHOCOLATE_BRICK.get(), 4)
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, DARK_CHOCOLATE_BRICK.get(), 4)
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, WHITE_CHOCOLATE_WORKBENCH.get())
				.define('@', WHITE_CHOCOLATE_BAR.get()).define('#', WAFER_STICK_BLOCK.get())
				.pattern("@@").pattern("##").unlockedBy("has_wafer_stick_block",
						has(WAFER_STICK_BLOCK.get())).save(consumer);
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, DARK_CHOCOLATE_WORKBENCH.get())
				.define('@', DARK_CHOCOLATE_BAR.get()).define('#', WAFER_STICK_BLOCK.get())
				.pattern("@@").pattern("##").unlockedBy("has_wafer_stick_block",
						has(WAFER_STICK_BLOCK.get())).save(consumer);

		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, WHITE_CANDY_CANE_WORKBENCH.get())
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RED_CANDY_CANE_WORKBENCH.get())
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, GREEN_CANDY_CANE_WORKBENCH.get())
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, WHITE_RED_CANDY_CANE_WORKBENCH.get())
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, WHITE_GREEN_CANDY_CANE_WORKBENCH.get())
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RED_GREEN_CANDY_CANE_WORKBENCH.get())
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, RED_GUMMY_WORKBENCH.get())
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ORANGE_GUMMY_WORKBENCH.get())
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, YELLOW_GUMMY_WORKBENCH.get())
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, WHITE_GUMMY_WORKBENCH.get())
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, GREEN_GUMMY_WORKBENCH.get())
